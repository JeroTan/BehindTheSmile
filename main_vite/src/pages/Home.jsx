...
const Box_wclick = ({image, text})=>{
    return <>
        <div class="relative w-80 box-border aspect-square cursor-pointer">
    ...
    let rendering = <>
        ...
        <main>
            ...
            <section class="flex justify-center flex-wrap gap-5 mx-10  ">
                <Box_wclick image="https://images.unsplash.com/photo-1604480132736-44c188fe4d20?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1980&q=80" text="What is Mental Heath?"/>
                <Box_wclick image="https://images.unsplash.com/photo-1554188572-9d184b57d8e2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80" text="Common Illnesses"/>
                <Box_wclick image="https://images.unsplash.com/photo-1511632765486-a01980e01a18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" text="Preventive Meassures"/>
            </section>
            <section class="block relative w-auto my-36 mx-10 box-border">
                ...
                <article class="flex justify-center w-full">
                    <div class="w-[62rem] px-5 pt-10 cursor-pointer">
